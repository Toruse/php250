...
<section class="container max-w-6xl mx-auto px-6 py-10 md:py-12">
    <div class="flex flex-col-reverse mb-10 lg:flex-row lg:mb-24">
        <div class="mt-8">
            ...
            <div class="flex my-10">
                <a href="/junior/general" title="{{ $page->ua->siteName }} getting started" class="bg-blue-500 hover:bg-blue-600 font-normal text-white hover:text-white rounded mr-4 py-2 px-6">Почати</a>
        ...
        <img src="/assets/img/logo-large.svg" alt="{{ $page->ua->siteName }} large logo" class="mx-auto mb-6 lg:mb-0 ">
    </div>
    ...
    <div class="md:flex -mx-2 -mx-4">
        <div class="mb-8 mx-3 px-2 md:w-1/3">
            ...
            <nav class="mt-4">
                @include('_nav.menu', ['items' => $page->ua->navigation->Junior->children, 'level' => 0])
            </nav>
        </div>
        ...
        <div class="mb-8 mx-3 px-2 md:w-1/3">
            ...
            <nav class="mt-4">
                @include('_nav.menu', ['items' => $page->ua->navigation->Middle->children, 'level' => 0])
            </nav>
        </div>
        ...
        <div class="mx-3 px-2 md:w-1/3">
            ...
            <nav class="mt-4">
                @include('_nav.menu', ['items' => $page->ua->navigation->Senior->children, 'level' => 0])
            </nav>
        </div>
    </div>
</section>
